                                        ...
                                        <tr id="{{ $rowId }}">
                                            ...
                                            <td class="px-4 py-3">
                                                ...
                                                <input name="empID"
                                                    ...
                                                    value="{{ $operator->empID }}" required
                                                    form="update-form-{{ $operator->id }}" />
                                            </td>
                                            ...
                                            <td class="px-4 py-3">
                                                ...
                                                <select name="role"
                                                    ...
                                                    <option value="OPERATOR"
                                                        {{ $operator->role === 'OPERATOR' ? 'selected' : '' }}>Operator
                                                    </option>
                                                    <option value="SUPERVISOR"
                                                        {{ $operator->role === 'SUPERVISOR' ? 'selected' : '' }}>Supervisor
                                                    </option>
                                                </select>
                                            </td>
                                            ...
                                            <td class="px-4 py-3">
                                                ...
                                                <input name="phoneNo" type="text"
                                                    class="hidden editable w-full mt-1 px-3 py-2 border border-gray-300 rounded-md dark:bg-gray-700 dark:text-white text-sm"
                                                    value="{{ $operator->phoneNo }}" required maxlength="15"
                                                    form="update-form-{{ $operator->id }}" />
                                            </td>
                                            ...
                                            <td class="px-4 py-3 text-center">
                                                <div class="flex space-x-2 justify-center">
                                                    ...
                                                    <form id="delete-form-{{ $operator->id }}"
                                                        action="{{ route('userDetails.destroy', $operator->id) }}"
