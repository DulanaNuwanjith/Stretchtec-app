<x-action-section>
    ...
    <x-slot name="content">
        ...
        <div class="mt-5">
            <div
                class="bg-yellow-50 border border-yellow-300 text-yellow-800 px-4 py-3 rounded-lg flex items-start shadow-sm">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mt-0.5 mr-3 text-yellow-500" fill="none"
