...
<x-guest-layout>
    <div class="min-h-screen flex items-center justify-center bg-gray-50 px-4 animate-fadeIn">
        <div class="max-w-md w-full bg-white p-8 rounded-lg shadow-lg text-center transform transition duration-300 hover:scale-105">
            <!-- Icon: Shield Lock -->
            <div class="flex justify-center mb-6">
                <svg class="w-16 h-16 text-red-600 animate-pulse" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 11c1.104 0 2-.672 2-1.5S13.104 8 12 8s-2 .672-2 1.5.896 1.5 2 1.5z"></path>
