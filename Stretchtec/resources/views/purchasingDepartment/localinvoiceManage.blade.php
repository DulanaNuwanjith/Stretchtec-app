...
<div class="flex h-full w-full">
    ...
    @section('content')
        <div class="flex-1 overflow-y-auto p-8 bg-white">
                ...
                <table class="table-fixed w-full text-sm divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-gray-200 dark:bg-gray-700 text-left">
                        <tr class="text-center">
                            ...
                            <th
                                class="font-bold sticky top-0 bg-gray-200 px-4 py-3 w-24 text-xs text-gray-600 dark:text-gray-300 uppercase">
                                TKT
                            </th>
                            <th
                                class="font-bold sticky top-0 bg-gray-200 px-4 py-3 w-28 text-xs text-gray-600 dark:text-gray-300 uppercase">
                            ...
                            <th
                                class="font-bold sticky top-0 bg-gray-200 px-4 py-3 w-40 text-xs text-gray-600 dark:text-gray-300 uppercase">
                                Supplier Comment
                            </th>
                            <th
                                class="font-bold sticky top-0 bg-gray-200 px-4 py-3 w-28 text-xs text-gray-600 dark:text-gray-300 uppercase">
                        ...
                        @forelse($localProcurements as $proc)
                            <tr class="odd:bg-white even:bg-gray-50 border-b border-gray-200 text-center">
                                ...
                                <td class="px-6 py-4 text-sm text-gray-800 dark:text-gray-200 border-r break-words">
                                    {{ $proc->tkt }}</td>
                                <td class="px-6 py-4 text-sm text-gray-800 dark:text-gray-200 border-r break-words">
                                    {{ $proc->quantity }} {{ $proc->uom }}</td>
                                <td
                                    class="px-6 py-4 text-sm text-gray-800 dark:text-gray-200 border-r break-words whitespace-normal">
                                    {{ $proc->supplier_comment }}</td>
                                <td class="px-6 py-4 text-sm text-gray-800 dark:text-gray-200 border-r break-words">
                                    {{ $proc->total_price }}</td>
                                <td class="px-6 py-4 text-sm text-gray-800 dark:text-gray-200 border-r break-words">
                                    {{ $proc->invoice_value }}</td>
                                <td class="px-6 py-4 text-sm text-gray-800 dark:text-gray-200 border-r break-words">
                                    <span
                    ...
                    <div class="max-w-[600px] mx-auto p-8">
                        ...
                        <form id="localProcForm" action="{{ route('localinvoiceManage.store') }}" method="POST">
                            ...
                            <div class="flex justify-end mt-6 space-x-3">
                                ...
                                <button type="submit" id="createlocalInvoiceBtn"
            ...
            <script>
                document.addEventListener('DOMContentLoaded', () => {
                    const form = document.querySelector('#addLocalProcModal form');
                    const submitBtn = document.getElementById('createlocalInvoiceBtn');
