    ...
    <div class="flex-1 overflow-y-auto p-8">
        ...
        <div class="flex flex-col md:flex-row md:space-x-8 space-y-8 md:space-y-0 max-w-7xl mx-auto">
            ...
            <form action="{{ route('report.order') }}" method="GET"
                ...
                <div>
                    <label for="order_no" class="block font-medium mb-2 text-gray-700 dark:text-gray-300">Enter Order
                        Number</label>
                ...
                <button type="submit"
                        class="w-full bg-blue-600 hover:bg-blue-700 text-white py-2 rounded transition">Generate Report
                </button>
            </form>
            ...
            <form action="{{ route('report.inquiryRange') }}" method="GET"
                ...
                <button type="submit"
                        class="w-full bg-blue-600 hover:bg-blue-700 text-white py-2 rounded transition">Download PDF
                </button>
            </form>
